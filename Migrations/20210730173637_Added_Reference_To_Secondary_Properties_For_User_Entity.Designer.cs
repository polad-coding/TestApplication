...
namespace KPProject.Migrations
{
    ...
    [Migration("20210730173637_Added_Reference_To_Secondary_Properties_For_User_Entity")]
    partial class Added_Reference_To_Secondary_Properties_For_User_Entity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KPProject.Models.ApplicationUserAssociatedCoupon", b =>
                {
                    ...
                    b.Property<int>("AssociatedCouponId")
                        .HasColumnType("int");

                    b.HasKey("ApplicationUserId", "AssociatedCouponId");

                    b.HasIndex("AssociatedCouponId");

                    b.ToTable("ApplicationUserAssociatedCoupons");
                });
            ...
            modelBuilder.Entity("KPProject.Models.AssociatedCoupon", b =>
                {
                    ...
                    b.Property<int?>("NumberOfUsagesLeft")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KPProject.Models.GeneralCoupon", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KPProject.Models.ApplicationUserAssociatedCoupon", b =>
                {
                    ...
                    b.HasOne("KPProject.Models.AssociatedCoupon", "AssociatedCoupon")
                        .WithMany("ApplicationUserAssociatedCoupons")
                        .HasForeignKey("AssociatedCouponId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("KPProject.Models.ApplicationUserEducation", b =>
                {
                    b.HasOne("KPProject.Models.ApplicationUser", "ApplicationUser")
                        .WithMany("ApplicationUserEducations")
                        .HasForeignKey("ApplicationUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("KPProject.Models.ApplicationUserPosition", b =>
                {
                    b.HasOne("KPProject.Models.ApplicationUser", "ApplicationUser")
                        .WithMany("ApplicationUserPositions")
                        .HasForeignKey("ApplicationUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
